...
local sliding_proto = Proto("StopWait","Stop and Wait File Transfer Protocol")
...
function sliding_proto.dissector(buffer,pinfo,tree)
    ...
    local subtree = tree:add(sliding_proto,buffer(),"Stop and Wait File Transfer Protocol Data")
...
-- works only on UDP ports 5000, 5001, 5002, 50000 and 50001
udp_table:add(5000,sliding_proto)
udp_table:add(5001,sliding_proto) 
udp_table:add(5002,sliding_proto)
